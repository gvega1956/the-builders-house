                  ...
                  return (
                    <button key={p.id} onClick={() => addToCart(p)}
                      ...
                      <div className="text-right">
                        <div className="text-sm font-bold" style={{ color: brand.orange[500] }}>{formatCurrency(Number(p.retailPrice))}</div>
          ...
          {customerId && selectedCustomer ? (
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="text-xs text-slate-400">{selectedCustomer.code}</div>
              </div>
